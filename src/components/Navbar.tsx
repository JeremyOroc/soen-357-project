  ...
  return (
    <header className="w-full border-b border-slate-200 dark:border-slate-700/50 bg-white/80 dark:bg-[#0f0d1a]/80 backdrop-blur-md sticky top-0 z-40">
      <div className="max-w-lg mx-auto px-4 h-14 flex items-center justify-between">
        {/* Logo */}
        <span className="font-bold text-brand-600 dark:text-brand-400 tracking-tight">
          KeepMovingForward
        </span>
        ...
        <button
          ...
          className="w-9 h-9 rounded-full flex items-center justify-center text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
        >
          {dark ? (
            // Sun icon
